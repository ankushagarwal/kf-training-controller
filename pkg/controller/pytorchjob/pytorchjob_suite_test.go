...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "PyTorchJob Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("PyTorchJobController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("PyTorchJobController")
})
