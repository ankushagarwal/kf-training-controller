...
func (c *FakeTFJobs) UpdateStatus(tFJob *v1alpha2.TFJob) (*v1alpha2.TFJob, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(tfjobsResource, "status", c.ns, tFJob), &v1alpha2.TFJob{})
