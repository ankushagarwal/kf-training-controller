...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the TFJob resource tests

var _ = Describe("TFJob", func() {
	var instance TFJob
	var expected TFJob
	var client TFJobInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.KubeflowV1alpha2().TFJobs("default")
